...
// const trendsButtons = [
//   {title: 'day', path: 'day'},
//   {title: 'week', path: 'week'},
// ];
// const popularsButtons = [
//   {title: 'Airing today', path: 'airing_today'},
//   {title: 'On the air', path: 'on_the_air'},
// ];
...
//         `https://api.themoviedb.org/3/trending/movie/${filmPeriod}?language=en-US`,
//       ),
//   });
//   const {
//     data: popularMovies,
...
//         `https://api.themoviedb.org/3/tv/${popularOn}?language=en-US`,
//       ),
//   });
//   const {
...
//     queryFn: () =>
//       fetchData<FetchResponse<TvShowShort[]>>(
//         `https://api.themoviedb.org/3/tv/${tvPopular}?language=en-US`,
//       ),
//   });
